...
globalKeyframes('progress-bar-stripes', {'0%': {  backgroundPositionX:"1rem",
},});globalKeyframes('progress-bar-stripes', {'0%': {  backgroundPositionX:"1rem",
},});globalKeyframes('spinner-border', {'to': {  transform:"rotate(360deg)",
},});globalKeyframes('spinner-border', {'to': {  transform:"rotate(360deg)",
},});globalKeyframes('spinner-grow', {'0%': {  transform:"scale(0)",
},'50%': {  opacity:"1",
  transform:"none",
},});globalKeyframes('spinner-grow', {'0%': {  transform:"scale(0)",
},'50%': {  opacity:"1",
...
},});globalKeyframes('placeholder-wave', {'100%': {  WebkitMaskPosition:"-200% 0%",
  maskPosition:"-200% 0%",
},});globalKeyframes('placeholder-wave', {'100%': {  WebkitMaskPosition:"-200% 0%",
  maskPosition:"-200% 0%",
},});globalStyle("*", {
